...
namespace automation.mbtdistr.ru.Migrations
{
    ...
    [Migration("20250527103624_OrdersToReturns")]
    partial class OrdersToReturns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.ProductBarcode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Worker", b =>
                {
                    ...
                    b.Property<string>("SessionStorage")
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.ProductBarcode", b =>
                {
                    b.HasOne("automation.mbtdistr.ru.Models.Product", "Product")
                        .WithMany("Barcodes")
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Return", b =>
                {
                    ...
                    b.HasOne("automation.mbtdistr.ru.Models.Warehouse", "CurrentWarehouse")
                        .WithMany("CurrentReturns")
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Warehouse", b =>
                {
                    ...
                    b.OwnsOne("automation.mbtdistr.ru.Models.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Services.YandexMarket.Models.YMCurrencyValue", b =>
                {
                    b.HasOne("automation.mbtdistr.ru.Services.YandexMarket.YMSupplyRequestItem", "SupplyRequestItem")
                        .WithOne("Price")
                        .HasForeignKey("automation.mbtdistr.ru.Services.YandexMarket.Models.YMCurrencyValue", "YMSupplyRequestItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Warehouse", b =>
                {
                    b.Navigation("CurrentReturns");

                    b.Navigation("DestinationReturns");
                });
