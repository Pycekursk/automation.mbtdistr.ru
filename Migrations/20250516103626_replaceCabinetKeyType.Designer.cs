...
namespace automation.mbtdistr.ru.Migrations
{
    ...
    [Migration("20250516103626_replaceCabinetKeyType")]
    partial class replaceCabinetKeyType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Return", b =>
                {
                    ...
                    b.Property<string>("ReturnId")
                        .HasColumnType("longtext")
                        .HasAnnotation("Relational:JsonPropertyName", "returnId");
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Address", b =>
                {
                    b.HasOne("automation.mbtdistr.ru.Models.Warehouse", "Warehouse")
                        .WithOne("Address")
                        .HasForeignKey("automation.mbtdistr.ru.Models.Address", "WarehouseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("automation.mbtdistr.ru.Models.Return", b =>
                {
                    ...
                    b.HasOne("automation.mbtdistr.ru.Models.Warehouse", null)
                        .WithMany("Returns")
