    ...
    public partial class first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YMLocationAddresses", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YMSupplyRequestLocation", x => x.ServiceId);
                    table.ForeignKey(
                        name: "FK_YMSupplyRequestLocation_YMLocationAddresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "YMLocationAddresses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ExternalIdId = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    TargetLocationServiceId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_YMSupplyRequests_YMSupplyRequestLocation_TargetLocationServi~",
                        column: x => x.TargetLocationServiceId,
                        principalTable: "YMSupplyRequestLocation",
                        principalColumn: "ServiceId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_YMSupplyRequests_YMSupplyRequestLocation_TransitLocationServ~",
